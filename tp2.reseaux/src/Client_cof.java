...
public class Client_cof {

    public static void main(String[] args) throws Exception
    {
        InetAddress adrslocal = InetAddress.getLocalHost();
        Socket cl = new Socket (adrslocal.getHostName(),12345);
        ...
        for (tab=0;tab<n;tab++)
        {
            ...
            System.out.print("tab_coefficient["+tab+"] = ");
            tab_cof [tab] = scn.nextInt();
            out.writeInt(tab_cof [tab]);
            System.out.println();
        }
